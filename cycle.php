...
<html lang="en">
    ...
    <nav class="navbar navbar-dark bg-dark">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a href="cycle.php" class="nav-link active">View Cycle</a>
            </li>
            <li class="nav-item">
                <a href="data.php" class="nav-link">View Battery</a>
            </li>
        </ul>
    </nav>
    <div class="container">
                ...
                <?php
                    ...
                    foreach($battery_data as $user) {
                        ...
                        for ( $iter = 1; $iter <= $num_days; $iter++) {
                            ...
                            $battery_cycle = $database->select("battery_cycle", [
                                'Clock_In'
                            ], [
                                'User_ID' => $user['No.'],
                                'Clock_In[<>]' => [
